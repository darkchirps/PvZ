...
public class progresspanel : MonoBehaviour
{
    ...
    public void SetPercent(float per)
    {
        ...
        // 进度条宽度
        float width = Bg.GetComponent<RectTransform>().sizeDelta.x/2;
    ...
    public void SetFlagPercent(float per)
    {
        ...
        // 设置位置
        newFlag.GetComponent<RectTransform>().position = new Vector2(originPosX- width* per, newFlag.GetComponent<RectTransform>().position.y);
